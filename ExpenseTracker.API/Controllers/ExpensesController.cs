...
{
    // Using RoutePrefix, we can specify prefix that applies to all the routes in this class.
    [RoutePrefix("api")]
    public class ExpensesController : ApiController
    {
        ...
        // Using Route attribute we map this request to getting all expenses in expensegroup 1: api/expensegroups/1/expenses
        ...
        // This is how we can map two routes to the same piece of code
